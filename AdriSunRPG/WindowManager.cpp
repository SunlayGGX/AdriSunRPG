...
void WindowManager::initialize()
{
    ...
    LoadString(dllInstance, IDR_ADRISUNRPG, m_windowClass, MAX_TITLE_COUNT);

    {
        ...
        wcex.lpfnWndProc = &AdriSunRPG::wndProcCallback;
        wcex.cbClsExtra = 0;
        wcex.cbWndExtra = 0;
        wcex.hInstance = dllInstance;
        wcex.hIcon = LoadIcon(wcex.hInstance, MAKEINTRESOURCE(IDI_ADRISUNRPG));
        wcex.hCursor = LoadCursor(NULL, IDC_ARROW);
        wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
        wcex.lpszMenuName = MAKEINTRESOURCE(IDR_ADRISUNRPG);
