    ...
    { //Create the device, the immediate context and the swap chain altogether
      ...
      //Swap chain mode initialization
...

        {
            ...
            descModeWanted.Height = MoonRPG::WINDOWED_HEIGTH_RESOLUTION;
            descModeWanted.Width = MoonRPG::WINDOWED_WIDTH_RESOLUTION;
            descModeWanted.RefreshRate.Numerator = MoonRPG::ENGINE_FPS;
        ...
        swapChainDesc.BufferDesc.RefreshRate.Numerator = MoonRPG::ENGINE_FPS;
        ...
        swapChainDesc.Windowed = MoonRPG::WINDOW_SIZE_CONFIGURATION;
...
{
    MoonRPG::UniqueDX<ID3D11Texture2D> backBuffer;
